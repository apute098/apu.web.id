    ...
    <html lang="id">
      ...
      >
        <main className="min-h-screen flex flex-col items-center justify-center p-4 text-center">
          <div className="max-w-md w-full rounded-none border border-[#22d3ee]/20 bg-[#111714] p-8 shadow-xl">
            ...
            <button
              ...
              className="px-5 py-2.5 rounded-none bg-[#FF6B14] text-white font-mono text-xs font-bold hover:bg-[#0ea5e9] transition-all cursor-pointer"
            >
              Muat Ulang
            </button>
          </div>
