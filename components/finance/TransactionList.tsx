  ...
  <div className="floating-card space-y-4">
      ...
      <div className="flex items-center gap-2 w-full md:w-auto">
        ...
        <div className="relative flex-1 md:w-56">
          ...
          <input
            ...
            className="w-full pl-8 pr-3 py-2.5 min-h-[44px] rounded-full liquid-glass border border-white/10 text-white text-xs focus:outline-none focus:border-[#22d3ee]/40"
          />
        </div>

        {/* Type Filter Buttons */}
        <div className="flex items-center gap-1 liquid-glass p-1 rounded-full border border-white/10">
    ...
    <div className="hidden md:block overflow-x-auto">
      <table className="w-full text-left text-xs">
        <thead className="liquid-glass text-slate-400 uppercase font-mono text-[10px] border-b border-white/10">
          <tr>
            ...
            transactions.map((tx) => (
              ...
              >
                ...
                <td className="py-3 px-4">
                  <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded font-mono text-[10px] liquid-glass text-[#06b6d4] border border-white/10">
            ...
            <div className="flex items-center justify-between gap-2">
              <div className="min-w-0">
                ...
                <p className="text-[10px] text-slate-400 mt-0.5 flex items-center gap-1.5">
                  <span className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded font-mono liquid-glass text-[#06b6d4] border border-white/10">
