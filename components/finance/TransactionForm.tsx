    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-2.5 min-h-[44px] rounded-none bg-slate-800 border border-slate-700 text-white text-xs font-mono focus:outline-none focus:border-[#22d3ee]/40"
            required
          />
        </div>
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-3 py-2.5 min-h-[44px] rounded-none bg-slate-800 border border-slate-700 text-white text-xs focus:outline-none focus:border-[#22d3ee]/40"
          >
      ...
      <div className="flex items-center justify-end gap-3 pt-2">
        <button
          type="button"
          onClick={onClose}
          className="px-4 py-2.5 min-h-[44px] rounded-none text-xs text-slate-400 hover:text-white hover:bg-slate-700 transition-all"
        >
          Batal
        </button>
        <button
          type="submit"
          disabled={submitting}
          className="px-5 py-2 rounded-none text-xs font-bold bg-[#22d3ee] text-white hover:bg-[#22d3ee] disabled:opacity-50"
        >
