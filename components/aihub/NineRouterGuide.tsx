...
export const NineRouterGuide: React.FC = () => {
  ...
  return (
    <div className="p-1 rounded-none bg-gradient-to-br from-white/10 via-white/5 to-white/0 border-2 border-slate-800 shadow-[8px_8px_0_0_rgba(37,99,235,1)] transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] hover:border-cyan-500/30 group">
      <div className="rounded-none bg-slate-950 p-6 sm:p-8 space-y-8">
        {/* Header & Status */}
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <h3 className="text-xl font-black tracking-tight text-white flex items-center gap-2">
                  9Router AI Gateway
                  <span className="text-xs font-normal font-mono px-2 py-0.5 rounded-none bg-cyan-500/10 text-cyan-400 border border-cyan-500/20">
                    Local Proxy v1.x
                  </span>
                </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-4 rounded-none bg-slate-900 border border-slate-700 border border-white/10 space-y-2">
            <div className="flex items-center gap-2 text-cyan-400 text-xs font-bold">
              <Zap className="w-4 h-4" />
              Base URL Standard
            </div>
            <div className="font-mono text-xs text-slate-200 bg-black/40 px-3 py-1.5 rounded-none border border-white/5">
        ...
        <div className="space-y-3">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div className="flex items-center gap-1.5 bg-slate-900/80 p-1 rounded-none border border-white/10">
          ...
          <div className="relative rounded-none bg-slate-950 border border-white/10 p-5 font-mono text-xs text-slate-200 overflow-x-auto shadow-inner">
            <pre className="text-cyan-300/90 whitespace-pre">{currentSnippet.code}</pre>
            <button
              onClick={handleCopy}
              className="absolute top-4 right-4 flex items-center gap-1.5 px-3 py-1.5 rounded-none bg-blue-600 text-white hover:bg-white/15 text-slate-200 border border-white/10 active:scale-95 transition-all text-xs font-semibold"
            >
              {copied ? (
                <>
