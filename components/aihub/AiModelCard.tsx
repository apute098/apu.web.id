...
export const AiModelCard: React.FC<AiModelCardProps> = ({
  ...
  return (
    <div className="p-1.5 rounded-none bg-slate-900 border border-slate-700 border border-white/10 transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] hover:border-cyan-500/30 group">
      <div className="rounded-none bg-slate-950 p-5 sm:p-6 flex flex-col h-full relative overflow-hidden">
        
        {/* Glow effect from accent */}
        <div 
          className="absolute -top-24 -right-24 w-48 h-48 rounded-none  opacity-20 pointer-events-none transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] group-hover:opacity-40"
        ...
        <div className="flex-1 space-y-6 relative z-10">
          ...
          <div className="flex items-start justify-between gap-4">
            <div className="space-y-2">
              <span className="inline-flex items-center px-2.5 py-0.5 rounded-none border border-white/10 bg-slate-900 border border-slate-700 text-[10px] uppercase tracking-[0.15em] font-medium text-slate-300 font-mono ">
                {model.provider}
              </span>
            ...
            <div className="relative overflow-hidden rounded-none px-3 py-1 flex items-center justify-center shrink-0">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="p-3 rounded-none bg-white/[0.02] border border-white/5 ">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="w-full h-1.5 rounded-none bg-slate-900 border border-slate-700 overflow-hidden">
                <div
                  className="h-full rounded-none transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)]"
        ...
        <div className="flex items-center justify-between gap-3 mt-8 pt-5 border-t border-white/10 relative z-10">
          <button
            ...
            className={`min-h-[44px] min-w-[44px] w-11 h-11 flex items-center justify-center rounded-none transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] border ${
              isSelectedForCompare
          ...
          <button
            ...
            className="flex-1 min-h-[44px] p-1.5 rounded-none bg-slate-900 border border-slate-700 border border-white/10 text-white font-sans text-sm font-medium transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] hover:bg-blue-600 text-white group/btn flex items-center justify-between pl-5 "
          >
            <span>View Specifications</span>
            <div 
              className="w-8 h-8 rounded-none flex items-center justify-center transition-transform duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] group-hover/btn:scale-105"
