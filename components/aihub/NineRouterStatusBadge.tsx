...
export const NineRouterStatusBadge: React.FC<NineRouterStatusBadgeProps> = ({
  ...
  return (
    <div className="inline-flex items-center gap-3 px-4 py-2 rounded-none bg-slate-900 border border-slate-700 border border-white/10  shadow-lg">
      <div className="flex items-center gap-2">
        {status === 'online' ? (
          ...
          <span className="relative flex h-2.5 w-2.5">
            <span className="animate-spin inline-flex rounded-none h-2.5 w-2.5 border border-cyan-400 border-t-transparent"></span>
          </span>
        ) : (
          <span className="relative flex h-2.5 w-2.5">
            <span className="relative inline-flex rounded-none h-2.5 w-2.5 bg-rose-500"></span>
          </span>
        )}
      ...
      <button
        ...
        className="p-1 rounded-none text-slate-400 hover:text-cyan-400 hover:bg-slate-900 border border-slate-700 active:scale-95 transition-all"
      >
